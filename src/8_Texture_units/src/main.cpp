...
int main()
{
    ...
    */
    ...
    Shader myProgram(
                "../../../src/8_Texture_units/shaders/vertexShader.vs",
                "../../../src/8_Texture_units/shaders/fragmentShader.fs" );
    ...
    image = stbi_load("../../../src/8_Texture_units/textures/note.png", &width, &height, &numberChannels, 0);
    if(image)
    {
