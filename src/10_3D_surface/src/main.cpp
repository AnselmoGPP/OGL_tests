...
int main()
{
    ...
    Shader myProgram(
                "../../../src/10_3D_surface/shaders/vertexShader.vs",
                "../../../src/10_3D_surface/shaders/fragmentShader.fs" );
    ...
    image = stbi_load("../../../src/10_3D_surface/textures/box1.jpg", &width, &height, &numberChannels, 0);
    if(image)
    {
    ...
    image = stbi_load("../../../src/10_3D_surface/textures/note.png", &width, &height, &numberChannels, 0);
    if(image)
    {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        model = glm::rotate(model, glm::radians(-55.0f), glm::vec3(1.0f, 0.0f, 0.0f));      // (float)chron.GetTime()
