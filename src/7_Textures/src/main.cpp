...
int main()
{
    ...
    */
    ...
    Shader myProgram(
                "../../../src/7_Textures/shaders/vertexShader.vs",
                "../../../src/7_Textures/shaders/fragmentShader.fs" );
    ...
    unsigned char *image = stbi_load("../../../src/7_Textures/textures/box1.jpg", &width, &height, &numberChannels, 0);
    if(image)
    {
